  ...
  var require_react_dom_development = __commonJS((exports) => {
    ...
    if (true) {
      (function() {
        ...
        function updateMemoComponent(current2, workInProgress2, Component6, nextProps, updateLanes, renderLanes2) {
          if (current2 === null) {
        ...
        function updateSimpleMemoComponent(current2, workInProgress2, Component6, nextProps, updateLanes, renderLanes2) {
          {
            if (workInProgress2.type !== workInProgress2.elementType) {
        ...
        function updateFunctionComponent(current2, workInProgress2, Component6, nextProps, renderLanes2) {
          ...
          prepareToReadContext(workInProgress2, renderLanes2);
          {
            ReactCurrentOwner$1.current = workInProgress2;
            setIsRendering(true);
            nextChildren = renderWithHooks(current2, workInProgress2, Component6, nextProps, context2, renderLanes2);
            if (workInProgress2.mode & StrictMode) {
              disableLogs();
              try {
                nextChildren = renderWithHooks(current2, workInProgress2, Component6, nextProps, context2, renderLanes2);
            ...
            case MemoComponent: {
              {
                if (workInProgress2.type !== workInProgress2.elementType) {
                  ...
                  if (outerPropTypes) {
                    checkPropTypes(outerPropTypes, resolvedProps, "prop", getComponentName(Component6));
                  }
                }
              }
              child = updateMemoComponent(null, workInProgress2, Component6, resolveDefaultProps(Component6.type, resolvedProps), updateLanes, renderLanes2);
              return child;
            }
          }
          var hint = "";
        ...
        function mountIndeterminateComponent(_current, workInProgress2, Component6, renderLanes2) {
          ...
          var value;
          {
            ...
            setIsRendering(true);
            ReactCurrentOwner$1.current = workInProgress2;
            value = renderWithHooks(null, workInProgress2, Component6, props, context2, renderLanes2);
            setIsRendering(false);
          }
          workInProgress2.flags |= PerformedWork;
          {
        ...
        function validateFunctionComponentInDev(workInProgress2, Component6) {
          {
            ...
            if (typeof Component6.contextType === "object" && Component6.contextType !== null) {
              var _componentName4 = getComponentName(Component6) || "Unknown";
...
For more info, visit https://reactjs.org/link/mock-scheduler`);
  ...
  var NavBar = class extends import_react4.Component {
    constructor(props) {
      super(props);
    }
    render() {
      return /* @__PURE__ */ import_react4.default.createElement("nav", {
        ...
        href: "index.html"
      }, /* @__PURE__ */ import_react4.default.createElement("i", null, "Capstone Web Arcade"))), /* @__PURE__ */ import_react4.default.createElement("div", {
        ...
        href: "index.html"
      }, "Home")), /* @__PURE__ */ import_react4.default.createElement("li", null, /* @__PURE__ */ import_react4.default.createElement("a", {
        href: "about.html"
      }, "About")), /* @__PURE__ */ import_react4.default.createElement("li", null, /* @__PURE__ */ import_react4.default.createElement("a", {
        href: "contact.html"
      }, "Contact")), /* @__PURE__ */ import_react4.default.createElement("li", null, /* @__PURE__ */ import_react4.default.createElement("a", {
        href: "high_scores.html"
      }, "High Scores"))))));
    }
  };
  var navbar_default = NavBar;

  // client/components/GameOverlay.jsx
  var import_react10 = __toModule(require_react());

  // client/components/GameComponent.jsx
  ...
  async function postData(endpoint, data, cb_success, cb_error) {
  ...
  var GameComponent = class extends import_react5.Component {
    constructor(props) {
      super(props);
  ...
  var GameComponent_default = GameComponent;

  // client/components/RatingComponent.jsx
  var import_react7 = __toModule(require_react());

  // client/components/RatingButton.jsx
  var import_react6 = __toModule(require_react());
  var RatingButton = class extends import_react6.Component {
    constructor(props) {
      super(props);
    }
    vote(isPositive) {
  ...
  var RatingButton_default = RatingButton;

  // client/components/RatingComponent.jsx
  var RatingComponent = class extends import_react7.Component {
    constructor(props) {
      super(props);
    }
    ...
    render() {
      ...
      return /* @__PURE__ */ import_react7.default.createElement("div", null, /* @__PURE__ */ import_react7.default.createElement(RatingButton_default, {
        isPositive: false
      }), /* @__PURE__ */ import_react7.default.createElement("span", {
        style: {color: percentageColor}
      }, this.props.positivePercentage, "%"), /* @__PURE__ */ import_react7.default.createElement(RatingButton_default, {
        isPositive: true
      }));
    }
  };
  var RatingComponent_default = RatingComponent;

  // client/components/Score.jsx
  var import_react8 = __toModule(require_react());
  var import_prop_types4 = __toModule(require_prop_types());
  var Score = ({score, rank}) => /* @__PURE__ */ import_react8.default.createElement("tr", {
    className: "tblRow"
  }, /* @__PURE__ */ import_react8.default.createElement("td", {
    className: "rowNum"
  }, rank), /* @__PURE__ */ import_react8.default.createElement("td", {
    className: "initials"
  }, score.initial), /* @__PURE__ */ import_react8.default.createElement("td", {
    className: "score"
  }, score.score));
  ...
  var Scoreboard = ({scores}) => {
    return /* @__PURE__ */ import_react9.default.createElement("table", null, /* @__PURE__ */ import_react9.default.createElement("thead", null, scores && scores.map((score, rank) => /* @__PURE__ */ import_react9.default.createElement(Score_default, {
      key: score.scoreid,
      score,
      rank: rank + 1
    }))));
  ...
  // client/components/GameOverlay.jsx
  var GameOverlay = ({isPlaying, closeOverlay, gameid, scores}) => {
    ...
    }, "X"), /* @__PURE__ */ import_react10.default.createElement("div", {
      className: "grid-container"
    }, /* @__PURE__ */ import_react10.default.createElement("div", {
      className: "item1"
    }, /* @__PURE__ */ import_react10.default.createElement("h1", null, "Game Overlay Exists!")), /* @__PURE__ */ import_react10.default.createElement("div", {
      className: "item2"
    }), /* @__PURE__ */ import_react10.default.createElement("div", {
      className: "item3"
    }, /* @__PURE__ */ import_react10.default.createElement(GameComponent_default, {
      gameid
    })), /* @__PURE__ */ import_react10.default.createElement("div", {
      className: "item4"
    }, /* @__PURE__ */ import_react10.default.createElement(RatingComponent_default, {
      positivePercentage: 80
    })), /* @__PURE__ */ import_react10.default.createElement("div", {
      className: "item5"
    })), /* @__PURE__ */ import_react10.default.createElement(Scoreboard_default, {
      scores
    }));
  };
  var GameOverlay_default = GameOverlay;

  // client/components/AllGames.jsx
  var AllGames = () => {
    return /* @__PURE__ */ React.createElement("div", null);
  };
  var AllGames_default = AllGames;

  // client/components/About.jsx
  var import_react11 = __toModule(require_react());
  var About = () => {
    return /* @__PURE__ */ import_react11.default.createElement("div", null, /* @__PURE__ */ import_react11.default.createElement("h4", null, "Version 1.0.0"), /* @__PURE__ */ import_react11.default.createElement(Link, {
      to: "/"
    }, "Go Back"));
  };
  ...
  function App() {
    ...
    const [scores, setScores] = (0, import_react12.useState)(new Array(10));
    const [isBusy, setBusy] = (0, import_react12.useState)(true);
    ...
    if (isBusy) {
      return /* @__PURE__ */ import_react12.default.createElement("p", null, " please wait ");
    } else {
      return /* @__PURE__ */ import_react12.default.createElement("div", {
        className: "App"
      }, /* @__PURE__ */ import_react12.default.createElement(navbar_default, {
        isPlaying
      }), /* @__PURE__ */ import_react12.default.createElement(GameOverlay_default, {
        isPlaying,
        closeOverlay,
        gameid: 2,
        scores
      ...
      }, /* @__PURE__ */ import_react12.default.createElement("h1", null, "Sorry!"), /* @__PURE__ */ import_react12.default.createElement("p", {
        style: {color: "white"}
      }, "This website is currently under construction. We are working hard to create a better experience for you all. Thank you for your patience! :)", /* @__PURE__ */ import_react12.default.createElement("br", null), "-Web Arcade Dev Team"), /* @__PURE__ */ import_react12.default.createElement("button", {
        onClick: openOverlay
      }, "Open Overlay"), /* @__PURE__ */ import_react12.default.createElement(BrowserRouter, null, /* @__PURE__ */ import_react12.default.createElement("div", {
        className: "container"
      }, /* @__PURE__ */ import_react12.default.createElement(Route, {
        path: "/",
        exact: true,
        render: (props) => /* @__PURE__ */ import_react12.default.createElement(import_react12.default.Fragment, null, !isPlaying && games.length > 0 ? /* @__PURE__ */ import_react12.default.createElement(AllGames_default, {
          games
        }) : "No Games to Show")
      }), /* @__PURE__ */ import_react12.default.createElement(Route, {
        path: "/about",
  ...
  // client/index.jsx
  import_react_dom.default.render(/* @__PURE__ */ import_react13.default.createElement(import_react13.default.StrictMode, null, /* @__PURE__ */ import_react13.default.createElement(App_default, null)), document.getElementById("root"));
})();
